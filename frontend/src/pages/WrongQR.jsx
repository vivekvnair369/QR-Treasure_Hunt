...
export default function WrongQR() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-between p-6 text-center">
      ...
      <div className="z-10 max-w-md w-full my-auto">
        <div className="glass-card p-8 rounded-3xl border border-red-500/20 shadow-2xl">
